...
function people_contact_install(){
	update_option('a3rev_wp_people_contact_lite_version', '2.32.0');
	update_option('a3rev_wp_people_contact_version', '2.3.0');
	update_option('a3rev_wp_people_contact_ultimate_version', '2.3.0');
...
function a3_people_contact_lite_upgrade_plugin () {
	...
	update_option('a3rev_wp_people_contact_lite_version', '2.3.0');
	update_option('a3rev_wp_people_contact_version', '2.3.0');
	update_option('a3rev_wp_people_contact_ultimate_version', '2.3.0');
